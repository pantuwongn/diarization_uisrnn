...
def parse_arguments():
	return (Namespace(crp_alpha=1.0, observation_dim=256, rnn_depth=1, rnn_dropout=0.2, rnn_hidden_size=512, sigma2=None, 
				transition_bias=None, verbosity=2), 
			Namespace(batch_size=10, enforce_cluster_id_uniqueness=True, grad_max_norm=5.0, 
				learning_rate=1e-05, learning_rate_half_life=0, num_permutations=10, optimizer='adam', regularization_weight=1e-05, 
				sigma_alpha=1.0, sigma_beta=1.0, train_iteration=20000), 
			Namespace(beam_size=10, look_ahead=1, test_iteration=2)
	)
...
# 	model_parser.add_argument('--observation_dim', default=_DEFAULT_OBSERVATION_DIM,
# 								type=int, help='The dimension of the embeddings (e.g. d-vectors).')
# 	model_parser.add_argument('--rnn_hidden_size', default=512,
# 								type=int, help='The number of nodes for each RNN layer.')
# 	model_parser.add_argument('--rnn_depth', default=1,
# 								type=int, help='The number of RNN layers.')
